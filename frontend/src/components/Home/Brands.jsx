      ...
      <ul className="flex items-center w-fit h-[35vw] lg:h-[11vw] animate-slide hover:pause">
        {
          HOME_BRANDS.images.map((item, index) => (
            <NavLink to="/product/:productId" className="flex items-center justify-center h-full min-w-fit px-[10vw] lg:px-[4.5vw] overflow-hidden hover:bg-slate-50" key={index}>
